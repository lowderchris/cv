...
\hangindent=0.2cm Lowder, C., Yeates, A., \textit{Magnetic Flux Rope Identification and Characterization from\break Observationally-Driven Solar Coronal Models}. (submitted).
