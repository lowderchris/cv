...
Southwest Research Institute		& \textit{Office: } +1 303 546 9670\\
1050 Walnut Street				& \textit{Mobile:} +1 720 808 2847\\
Boulder, Colorado 80302, United States    & \textit{E-mail:} \href{mailto:lowder@boulder.swri.edu}{lowder@boulder.swri.edu}
\end{tabular}
...
\href{https://www.colorado.edu}{\textbf{University of Colorado Boulder}}\\
\href{https://www.colorado.edu/aps/}{\textbf{Astrophysical and Planetary Sciences}}
\hfill Boulder, Colorado, United States
\begin{outerlist}
\item[] \textit{Instructor}%
        \hfill \textbf{January 2020 to May 2020}
\begin{innerlist}

  \item Designed and taught Introduction to the Solar System course
  \item Integrated planetarium and observatory sessions into course material
  \item Utilized a Learning Assistant to assist in classroom activities, and to provide an undergraduate student with an active teaching experience
  \\
\end{innerlist}
...
\hangindent=0.2cm Lowder, C., \textit{The Coronal Hole Observer and Regional Tracker for Long-term Examination}. (in preparation).

\hangindent=0.4cm Lowder, C., Lamb, D., \& DeForest, C., \textit{Fluxon Modeling of the Steady Solar Wind}. (in preparation).

\hangindent=0.4cm Lowder, C., Yeates, A., \textit{Magnetic Flux Rope Identification and Characterization from\break Observationally-Driven Solar Coronal Models}. ApJ, 846, 106 (2017).
...
\hangindent=0.4cm \textit{Fluxon Modeling of CMEs and the Steady Solar Wind} AAS / SPD (2019).

\hangindent=0.4cm \textit{Open Magnetic Flux and Coronal Holes: Probing the Polar Regions} Polar Perspectives Workshop (2018).
...
\section{Computing}
\textit{Proficient} : Python (NumPy, SciPy, SunPy), Perl (PDL), MayaVi / VTK, Blender, IDL, SolarSoft, \LaTeX, OpenMPI, Fortran, Git/GitHub

\textit{Familiar} : C, C++, Octave, MATLAB, OpenCL, VisIt, Glue, Pandas
...
\href{https://www.swri.org}{\textbf{Southwest Research Institute}}\\
\href{http://www.boulder.swri.edu}{\textbf{Planetary Science Directorate\\ Department of Space Studies}}
\hfill Boulder, Colorado, United States
\begin{outerlist}
\item[] \textit{Research Scientist}%
        \hfill \textbf{December 2017 to Present}
\begin{innerlist}
  \item Working with \href{http://www.boulder.swri.edu/~deforest/}{Craig DeForest} and \href{http://www.boulder.swri.edu/~derek/}{Derek Lamb} on Fluxon MHD modeling of the solar corona.
  \item Assisting with integration of codes through the Fluxon Rapid Assimilative Nowcaster (FRAN).
  \\
\end{innerlist}
...
\href{http://www.ifa.hawaii.edu/}{\textbf{University of Hawaii}}\\
\href{http://www.ifa.hawaii.edu/}{\textbf{Institute for Astronomy}}
\hfill Honolulu, Hawaii, United States
\begin{outerlist}
\item[] \textit{NSF Summer REU Undergraduate Researcher}%
...
\href{https://aas.org}{American Astronomical Society (AAS)}

\href{https://spd.aas.org}{Solar Physics Division (SPD)}
